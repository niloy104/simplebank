...
func TestListTransfer(t *testing.T) {
	...
	arg := ListTransfersParams{
		FromAccountID: pgtype.Int8{Int64: account1.ID, Valid: true},
		ToAccountID:   pgtype.Int8{Int64: account1.ID, Valid: true},
		Limit:         5,
		Offset:        5,
	}
	...
	for _, transfer := range transfers {
		...
		require.True(
			t,
			(transfer.FromAccountID.Valid && transfer.FromAccountID.Int64 == account1.ID) ||
				(transfer.ToAccountID.Valid && transfer.ToAccountID.Int64 == account1.ID),
		)
	}
